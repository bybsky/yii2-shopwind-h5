...
class My_questionForm extends Model
{
	...
	public function formData($post = null, $pageper = 10)
	{
		...
		foreach($recordlist as $key => $record)
		{
			...
			if(empty($record['store_logo'])) $recordlist[$key]['portrait'] = Yii::$app->params['default_user_portrait']; 
		}
