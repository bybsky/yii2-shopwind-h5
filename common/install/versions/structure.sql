...
CREATE TABLE IF NOT EXISTS `swd_store` (
  ...
  `nav_color` varchar(10) DEFAULT '',
  `nav_show_style` tinyint(1) DEFAULT '0',
  `hot_search` varchar(255) DEFAULT '',
  `business_scope` varchar(50) DEFAULT '',
  `online_service` varchar(255) DEFAULT '',
  `hotline` varchar(255) DEFAULT '',
  `store_slides` text DEFAULT '',
